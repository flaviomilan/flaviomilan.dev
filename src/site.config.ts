...
const config: SiteConfig = {
  ...
  tags: ['Software Engineer', 'AI', 'CyberSecurity', 'Security'],
  ...
  // The homepage will display half this number in the "" section.
  pageSize: 6,
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/flaviomilan',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/flaviomilan',
    rss: true,
  },
  ...
  giscus: {
    repo: 'flaviomilan/flaviomilan.dev',
    repoId: 'R_kgDOQGHthQ',
    category: 'Giscus',
    categoryId: 'DIC_kwDOQGHthc4Cw4UY',
